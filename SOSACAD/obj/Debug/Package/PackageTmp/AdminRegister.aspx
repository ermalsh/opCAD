<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminRegister.aspx.cs" Inherits="SoSACAD.AdminRegister" %>
                            ...
                            <div class="panel-group full-body" id="accordion_13" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="panel panel-col-grey">
                                    <div class="panel-heading" role="tab" id="headingOne_13">
                                        <h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion_13" href="#collapseOne_13" aria-expanded="true" aria-controls="collapseOne_13">Admin Registration </a></h4>
                                    </div>
